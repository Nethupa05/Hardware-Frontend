    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Please log in to view your reservations</h2>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="px-6 py-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-gray-600">Track the status of your service reservations</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow border">
            <div className="text-3xl font-bold text-green-600">{statusCounts.confirmed}</div>
                ...
                {reservations.length === 0 ? (
                  <tr>
                    <td colSpan="4" className="px-6 py-12 text-center">
                      ...
                      <div className="text-gray-400 text-sm mt-2">You haven't made any reservations yet</div>
                      <a href="/book-reservation" className="btn btn-primary mt-4">Book a Reservation</a>
                    </td>
                  </tr>
                ) : (
                  reservations.map((reservation) => (
                    <tr key={reservation._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            {reservation.address ? reservation.address.substring(0, 30) + '...' : 'No address'}
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div>
                          <div>{new Date(reservation.createdAt).toLocaleDateString()}</div>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-gray-600">Reservation ID: #{selectedReservation._id.slice(-8).toUpperCase()}</p>
                  </div>
                  <button
                  ...
                  <div className="card">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <span className="ml-2 text-gray-900">{selectedReservation.name}</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Email:</span>
                        <span className="ml-2 text-gray-900">{selectedReservation.email}</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Phone:</span>
                        <span className="ml-2 text-gray-900">{selectedReservation.phone}</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Address:</span>
                        <span className="ml-2 text-gray-900">{selectedReservation.address || 'Not provided'}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="mt-2">{getStatusBadge(selectedReservation.status)}</div>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Requested:</span>
                        <span className="ml-2 text-gray-900">{new Date(selectedReservation.createdAt).toLocaleString()}</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Last Updated:</span>
                        <span className="ml-2 text-gray-900">{new Date(selectedReservation.updatedAt).toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {selectedReservation.note && (
                  <div className="mt-6">
                    <div className="card">
                      ...
                      <p className="text-gray-700 whitespace-pre-wrap">{selectedReservation.note}</p>
                    </div>
                  </div>
                )}
